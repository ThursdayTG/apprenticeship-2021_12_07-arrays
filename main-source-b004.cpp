...
g++ -Og -Wall -Wextra -Wpedantic -Werror main-source-b004.cpp -o main-newest.debug
...
g++ -Og main-source-b004.cpp -o main-newest.debug && clear && g++ -O3 -Wall -Wextra -Wpedantic -Werror main-source-b004.cpp -o main-newest.release && ./main-newest.release

	g++ -Og main-source-b004.cpp -o main-newest.debug
 && clear
 && g++ -O3 -Wall -Wextra -Wpedantic -Werror main-source-b004.cpp -o main-newest.release
 && ./main-newest.release
*/
