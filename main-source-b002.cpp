...
int main() {
	...
	do {
		...
		for (	inboxLoopCount = 0;
				...
				inboxLoopCount++) {
			outbox[inboxLoopCount] = inbox[inboxLoopCount];

			/*
			for (	outboxLoopCount = 0;
					outboxLoopCount < 20;
					outboxLoopCount++) {
				//lorem
			}
...
g++ -Og -Wall -Wextra -Wpedantic -Werror main-source-b002.cpp -o main-newest.debug
...
g++ -Og main-source-b002.cpp -o main-newest.debug && clear && g++ -O3 -Wall -Wextra -Wpedantic -Werror main-source-b002.cpp -o main-newest.release && ./main-newest.release

	g++ -Og main-source-b002.cpp -o main-newest.debug
 && clear
 && g++ -O3 -Wall -Wextra -Wpedantic -Werror main-source-b002.cpp -o main-newest.release
 && ./main-newest.release
*/
